...
~~~
python main_generate.py -pkt pockets/Mpro_initial/Mpro_initial_pocket15_5.pdb -lig pockets/Mpro_initial/structure_test_3_molecule_scaffold.sdf --idx "[12, 14, 15, 16]" --ckpt ./ckpt/150000.pt -n 500 -d cuda:0 --root_path gen_results --name Mpro -at 1.0 -bt 1.0 --max_atom_num 35 -ft 0.5 -cm True --with_print False
~~~
