...
from .complex_data import ComplexData, torchify_dict
from .protein_file_analyzer import Protein, Ligand
import pickle
import glob
import lmdb
import random
...
class CrossDocked2020(object):
    ...
    def run(self, dataset_name='XXX.lmdb', lmdb_path=None, 
            max_ligand_atom=50, only_backbone=True, n_process=16, interval=2000):
