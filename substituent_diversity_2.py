...
num_substituent_site_1 = substituent_diversity('./molecules_generated/generated_round_2.sdf', {16,17})
num_substituent_site_2 = substituent_diversity_1('./molecules_generated/generated_round_2.sdf', 9, skeleton_idx=set(range(28)))
num_substituent_site_3 = substituent_diversity_1('./molecules_generated/generated_round_2.sdf', 12, skeleton_idx=set(range(28)))

combination = ((num_substituent_site_1 | num_substituent_site_2)|num_substituent_site_3)
